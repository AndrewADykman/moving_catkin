...
set(MSG_I_FLAGS "-Iedumip_msgs:/home/andrew/catkin_ws/src/edumip_msgs/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/andrew/catkin_ws/src/edumip_msgs/msg/EduMipState.msg" NAME_WE)
add_custom_target(_edumip_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "edumip_msgs" "/home/andrew/catkin_ws/src/edumip_msgs/msg/EduMipState.msg" ""
)
...
_generate_msg_cpp(edumip_msgs
  "/home/andrew/catkin_ws/src/edumip_msgs/msg/EduMipState.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/edumip_msgs)
  install(CODE "execute_process(COMMAND \"/home/andrew/anaconda2/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/edumip_msgs\")")
  # install generated code
  install(
